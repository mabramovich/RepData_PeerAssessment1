...
Time interval `r as.integer(steps_by_interval[which.max(steps_by_interval$avg_steps_by_interval),"interval"])` - `r as.integer(steps_by_interval[which.max(steps_by_interval$avg_steps_by_interval),"interval"]) + 5` has the most average steps per day.
